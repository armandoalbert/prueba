...
for($i=0; $i<60; $i++){
    //array_push($boxes,['length' => 51,'width' => 49,'height' => 36, "id"=>"caja $i"] );
    array_push($boxes,['length' => 30,'width' => 30,'height' => 30, "id"=>"caja $i"] );
    //array_push($boxes,['length' => 36,'width' => 51,'height' => 49, "id"=>"caja $i"] );
}
